...
instance Print AbsTinyPlus.Stmt where
  prt i = \case
    ...
    AbsTinyPlus.Func expr -> prPrec i 0 (concatD [prt 0 expr, doc (showString ";")])
    ...
    AbsTinyPlus.PrintLn exprs -> prPrec i 0 (concatD [doc (showString "println"), prt 0 exprs, doc (showString ";")])
