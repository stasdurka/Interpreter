...
Program : ListTopDef 'main' Block { AbsMojeLatte.Program $1 $3 }
...
Block : '[' ListDecl ']' '{' Stmt '}' { AbsMojeLatte.Block $2 $5 }
...
Item
  ...
  | Ident '[' Expr ']' { AbsMojeLatte.ArrInit $1 $3 }
...
Stmt
  : Stmt Stmt { AbsMojeLatte.Seq $1 $2 }
  | ';' { AbsMojeLatte.Empty }
