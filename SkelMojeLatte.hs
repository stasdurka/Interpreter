...
transProgram x = case x of
  AbsMojeLatte.Program topdefs block -> failure x
...
transBlock x = case x of
  AbsMojeLatte.Block decls stmt -> failure x
...
transItem x = case x of
  ...
  AbsMojeLatte.ArrInit ident expr -> failure x

transStmt :: AbsMojeLatte.Stmt -> Result
transStmt x = case x of
  AbsMojeLatte.Seq stmt1 stmt2 -> failure x
